...
<?php
    ...
    while($row = mysqli_fetch_array($result0)){
        echo "ISCRIZIONI ATTAUALI:  ". $row['tot'] ."";
    }
...
<tr><td><b>Nome      </b></td><td><b>Cognome</b></td> <td><b>Sesso   </b></td> <td><b>Data</b></td> <td><b>   Luogo</b></td> <td><b>Società</b></td> <td><b>   Tipo tessera</b></td> <td><b> Numero tessera</b></td> <td><b>   Cellulare</b></td>  </tr>
...
<?php
    ...
    $sql="select * From Atleti_prova";
    $result = $conn->query($sql);
    while($cicle=mysqli_fetch_array($result)){
        echo "<tr><td>".$cicle['nome']."</td><td>".$cicle['cognome']."</td><td>".$cicle['sesso']."</td><td>".$cicle['data']."</td><td>".$cicle['luogonascita']."</td><td>".$cicle['societa']."</td><td>".$cicle['tipo']."</td><td>".$cicle['numero']."</td><td>".$cicle['cellulare']."</td></tr>";
    }
...
<form name="logout" action="accedi.php" method="post">
